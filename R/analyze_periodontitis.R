...
output_dir <- "/rsrch3/home/biostatistics/rsun3/sjlife/output/periodontitis"
outRoot <- "perioRes"
max_gene_size <- 5000
...
# load outcome data - change for outcomes
setwd("/rsrch3/home/biostatistics/rsun3/sjlife/data/outcomes")
outcomeTimes <- fread("periodontitis.csv", data.table=FALSE) %>%
